...
public interface DescriptionUnitFactory extends EFactory {
	 ...
	 * @generated
	 */
	DescriptionUnitFactory eINSTANCE = org.eclipse.mylyn.docs.intent.core.descriptionunit.impl.DescriptionUnitFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>Description Unit</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Description Bloc</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
