...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Intent Section Referencein Modeling Unit</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.mylyn.docs.intent.core.modelingunit.impl.IntentSectionReferenceinModelingUnitImpl#getIntentHref <em>Intent Href</em>}</li>
 *   <li>{@link org.eclipse.mylyn.docs.intent.core.modelingunit.impl.IntentSectionReferenceinModelingUnitImpl#getReferencedElement <em>Referenced Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntentSectionReferenceinModelingUnitImpl extends IntentSectionReferenceInstructionImpl implements IntentSectionReferenceinModelingUnit {
	 ...
	 * @generated
	 */
	protected IntentSectionReferenceinModelingUnitImpl() {
		super();
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IntentReference.class) {
			switch (derivedFeatureID) {
				case ModelingUnitPackage.INTENT_SECTION_REFERENCEIN_MODELING_UNIT__INTENT_HREF:
		...
		if (baseClass == ModelingUnitInstructionReference.class) {
			switch (derivedFeatureID) {
				case ModelingUnitPackage.INTENT_SECTION_REFERENCEIN_MODELING_UNIT__REFERENCED_ELEMENT:
		...
		if (baseClass == IntentReference.class) {
			switch (baseFeatureID) {
				case IntentDocumentPackage.INTENT_REFERENCE__INTENT_HREF:
					return ModelingUnitPackage.INTENT_SECTION_REFERENCEIN_MODELING_UNIT__INTENT_HREF;
				default:
					return -1;
			}
		}
		if (baseClass == ModelingUnitInstructionReference.class) {
			switch (baseFeatureID) {
				case ModelingUnitPackage.MODELING_UNIT_INSTRUCTION_REFERENCE__REFERENCED_ELEMENT:
					return ModelingUnitPackage.INTENT_SECTION_REFERENCEIN_MODELING_UNIT__REFERENCED_ELEMENT;
				default:
					return -1;
			}
		}
...
} //IntentSectionReferenceinModelingUnitImpl
