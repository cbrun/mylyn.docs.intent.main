...
/**
 * Entry point of the 'Latex' generation module.
 * 
 * @generated
 */
public class Latex extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 * 
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/eclipse/mylyn/docs/intent/markup/gen/files/latex";
  ...
  /**
	 ...
	 * @generated
	 */
	public Latex(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Latex(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Latex generator = new Latex(modelURI, folder, arguments);
  ...
  /**
	...
	public void registerPackages(ResourceSet resourceSet) {
		...
		resourceSet.getPackageRegistry().put(MarkupPackage.eNS_URI,
	...
	public void registerResourceFactories(ResourceSet resourceSet) {
		...
		// TODO If you need additional resource factories registrations, do them
