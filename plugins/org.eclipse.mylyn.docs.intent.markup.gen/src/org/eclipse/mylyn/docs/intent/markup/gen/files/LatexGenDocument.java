...
public class LatexGenDocument extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/eclipse/mylyn/docs/intent/markup/gen/files/LatexGenDocument";
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                LatexGenDocument generator = new LatexGenDocument(modelURI, folder, arguments);
