 ...
 * @generated
 */
public class Html extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/eclipse/mylyn/docs/intent/markup/gen/files/html";
  ...
  /**
	 ...
	 * @generated
	 */
	public Html(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Html(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Html generator = new Html(modelURI, folder, arguments);
