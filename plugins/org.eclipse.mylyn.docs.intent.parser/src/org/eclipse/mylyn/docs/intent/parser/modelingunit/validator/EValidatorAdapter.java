package org.eclipse.mylyn.docs.intent.parser.modelingunit.validator;
...
//
// /**
// * Direct validation of {@link EDataType}s is not supported by the EMF validation framework; they are
// * validated indirectly via the {@link EObject}s that hold their values.
// */
// @Override
...
//
// /**
// * If we have a context map, record this object's <code>status</code> in it so that we will know later
// * that we have processed it and its sub-tree.
// *
// * @param eObject
...
//
// /**
// * Determines whether we have processed this <code>eObject</code> before, by automatic recursion of the
// * EMF Model Validation Service. This is only possible if we do, indeed, have a context.
// *
// * @param eObject
// * an element to be validated (we hope not)
// * @param context
// * the context (may be <code>null</code>)
// * @return <code>true</code> if the context is not <code>null</code> and the <code>eObject</code> or one
// * of its containers has already been validated; <code>false</code>, otherwise
// */
