...
/**
 * A rule to detect Intent keywords.
 * 
...
public class KeywordRule implements ISequenceRule {
	...
	/**
	 * {@inheritDoc}
	 * @see org.eclipse.mylyn.docs.intent.client.ui.editor.rules.ISequenceRule#read(org.eclipse.jface.text.rules.ICharacterScanner)
	 */
